...
export class CommentSliderComponent implements OnInit {
  ...
  },
  {
    ...
    lastName: 'آریامهر',
    text:
    ' این که خودش با مقداری از سرمایه ترید میکنه و همه سرمایه من درگیر نیست و منم میتونم ترید شخصی خودم رو با پنل معامله انجام بدم بسیار کاربرد و مزیت عالیه ممنونم از خدماتتون '
  },
  {
    gender: true,
    firstname: 'صادقی',
