...
!(function () {
  ...
  var o,
    ...
    l = {
      ...
      calculateWidgetHeight: function (t, e) {
        ...
        return r && e && (this.embedStylesForFullHeight(o + i, n, e), n)
          ? 100 + i
          : n
          ? "calc(" + o + i + " - 32px)"
          : o + i;
      ...
      MediumWidget: function (t) {
        ...
        switch (t.chartType) {
          ...
          case "bars": {
            ...
            o = { chartType: e, upColor: i, downColor: r };
            break;
          }
          case "line": {
            const {
      ...
      widget: function (t) {
        ...
        (this.options = {
          ...
          style: t.style || "",
          extended_hours:
            void 0 === t.extended_hours ? void 0 : +t.extended_hours,
          details: !!t.details,
          calendar: !!t.calendar,
          hotlist: !!t.hotlist,
          ...
          isFinite(t.widgetbar_width) &&
            t.widgetbar_width > 0 &&
            (this.options.widgetbar_width = t.widgetbar_width),
  ...
  (l.WidgetAbstract.prototype = {
    ...
    addWrapperFrame: function (t) {
      ...
      return (
        (e.id = this.id + "-wrapper"),
        (e.style.cssText =
          "position: relative;box-sizing: content-box;margin: 0 auto !important;padding: 0 !important;font-family: " +
          d +
          ";"),
    ...
    (l.EventsWidget.prototype = {
      ...
      render: function () {
        ...
        return (
          (e.title = l.getWidgetTitleAttribute(
            this.options.iframeTitle,
            this.widgetId
          )),
    ...
    (l.MediumWidget.prototype = {
      ...
      render: function () {
        ...
        for (var o of Object.keys(e)) t[o] = e[o];
        const i = new URL(
          "/embed-widget/symbol-overview/",
          l.getHost(this.options)
        );
        this.options.customer && (i.pathname += this.options.customer + "/"),
          this.options.locale &&
            i.searchParams.append("locale", this.options.locale),
          (i.hash = encodeURIComponent(JSON.stringify(t)));
        const r = document.createElement("iframe");
        return (
          (r.title = l.getWidgetTitleAttribute(
            this.options.iframeTitle,
            this.widgetId
          )),
    ...
    (l.widget.prototype = {
      ...
      render: function () {
        ...
        return (
          (t.title = l.getWidgetTitleAttribute(
            this.options.iframeTitle,
            this.widgetId
          )),
      ...
      generateUrl: function (t) {
        ...
        e =
          "cme" === (t = t || this.options).customer
            ? "/cmewidgetembed/"
            : t.customer
            ? "/" + t.customer + "/widgetembed/"
            : "/widgetembed/";
        ...
        n.searchParams.append("hideideas", "1"),
          n.searchParams.append(
            "overrides",
            JSON.stringify(h(t.overrides, {}))
          ),
          n.searchParams.append(
            "enabled_features",
            JSON.stringify(h(t.enabled_features, []))
          ),
          n.searchParams.append(
            "disabled_features",
            JSON.stringify(h(t.disabled_features, []))
          ),
        ...
        return (
          ...
          t.studies &&
            l.isArray(t.studies) &&
            ("string" == typeof t.studies[0]
              ? o("studies", t.studies.join(""))
              : o("studies", t.studies)),
          ...
          o(
            "utm_medium",
            l.hasCopyright(t.container) ? "widget_new" : "widget"
          ),
    ...
    (l.chart.prototype = {
      ...
      create: function () {
        ...
        c(e, this.options),
          ...
          l.bindEvent(o, "load", function () {
            var t;
            for (i._ready = !0, t = i._ready_handlers.length; t--; )
          ...
          l.onready(function () {
            ...
            if (
              ...
              for (
                var e = document.getElementsByTagName("a"),
                  r = new RegExp("/v/" + i.options.chart + "/$"),
                  n = new RegExp(
            ...
            t && ((o.src += "#nolinks"), (o.name = "nolinks"));
          });
      },
      ...
      render: function () {
        ...
        l.addUrlParams(
          t,
          { method: "script", locale: this.options.locale },
          !0
        ),
    ...
    (l.stream.prototype = {
      ...
      render: function () {
        ...
        l.addUrlParams(t, { locale: this.options.locale }, !0),
          (this.options.type = "chart"),
          l.addUrlParams(t, l.generateUtmForUrlParams(this.options));
        const e = document.createElement("iframe");
        return (
        ...
        window.addEventListener("message", function (t) {
          ...
          if (e && e.provider && "TradingView" === e.provider)
            if (((e.source = t.source), "get" === e.type)) {
              ...
              i[e.client_id] &&
                i[e.client_id][e.id] &&
                (i[e.client_id][e.id].call(e, e.data),
        ...
        return (
          ...
          (o = t),
          {
            ...
            get: function (t, o, r) {
              ...
              (i[e][s.id] = r), n[e].postMessage(JSON.stringify(s), "*");
            },
            post: function (t, e, o) {
              var i = {
                id: s++,
    ...
    (l.createUrlParams = function (t) {
      ...
      for (var o in t)
        t.hasOwnProperty(o) &&
          null != t[o] &&
          e.push(encodeURIComponent(o) + "=" + encodeURIComponent(t[o]));
      return e.join("&");
    }),
  ...
  window.TradingView
    ? (function t(e, o) {
        for (var i in o)
          "object" == typeof o[i] && e.hasOwnProperty(i)
            ? t(e[i], o[i])
            : (e[i] = o[i]);
        return e;
      })(window.TradingView, l)
    : (window.TradingView = l);
})();
